...
const AddJob = () => {
  ...
  return (
    <form className="container p-4 flex flex-col w-full items-start gap-3">
      ...
      <div>
        <p>Paying</p>
        <input min={0} className="w-full px-3 py-2 border border-gray-300 rounded sm:w-[120px]" onChange={e => setSalary(e.target.value)} type="Number" placeholder="$1916"/>
      </div>
      <button className="w-28 py-3 mt-4 bg-black text-white rounded">SAVE</button>
    </form>
  );
};
